...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> findOwnersItems(long userId, long from, long size) {
    ...
    public ResponseEntity<Object> addComment(CommentRequestDto comment) {
        return post("/" + comment.getItemId() + "/comment", comment.getAuthorId(), comment);
    }
