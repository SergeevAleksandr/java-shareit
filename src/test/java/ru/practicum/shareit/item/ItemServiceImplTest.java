...
class ItemServiceImplTest {
    ...
    void findItemByIdTest() {
        ...
        ItemDtoWithBookingDates itemDto = itemService.getItemById(item.getId(), user.getId());
    ...
    void findOwnersItemsTest() {
        ...
        List<ItemDtoWithBookingDates> itemList = itemService.getAllItems(user.getId(), Pageable.ofSize(10));
    ...
    void findAvailableItems() {
        ...
        List<ItemDto> itemList = itemService.findItemFromAvailable("itemname", Pageable.ofSize(10));
    ...
    void lastNextBookingTest() {
        ...
        List<ItemDtoWithBookingDates> itemList = itemService.getAllItems(user1.getId(), Pageable.ofSize(10));
    ...
    void updateWrongOwnerTest() {
        ...
        assertEquals("Чужая вещь не можеть быть обновлена", e.getMessage());
    }

    @Test
    void findItemByIdWrongIdTest() {
        when(itemRepository.findById(any())).thenReturn(Optional.empty());
        NotFoundException e = assertThrows(NotFoundException.class, () -> itemService.getItemById(1L, 1L));
