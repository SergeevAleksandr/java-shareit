...
class ItemRequestControllerTest {
    ...
    void createTest() throws Exception {
        when(itemRequestService.addItemRequest(any())).thenReturn(requestDto);
    ...
    void findItemRequestsByRequestorTest() throws Exception {
        when(itemRequestService.findAllByOwner(anyLong())).thenReturn(List.of(requestDtoResponse));
    ...
    void findItemRequests() throws Exception {
        when(itemRequestService.findAll(anyLong(), any())).thenReturn(List.of(requestDtoResponse));
    ...
    void findItemRequestsById() throws Exception {
        when(itemRequestService.findRequest(anyLong(), anyLong())).thenReturn(requestDtoResponse);
