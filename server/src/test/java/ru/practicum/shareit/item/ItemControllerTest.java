...
public class ItemControllerTest {
    ...
    void findItemByIdTest() throws Exception {
        when(itemService.getItemById(anyLong(), anyLong())).thenReturn(itemDtoWithBookingDates);
    ...
    void findOwnersItemsTest() throws Exception {
        when(itemService.getAllItems(anyLong(), any())).thenReturn(Collections.singletonList(itemDtoWithBookingDates));
    ...
    void findAvailableItemsTest() throws Exception {
        when(itemService.findItemFromAvailable(anyString(), any())).thenReturn(Collections.singletonList(itemDto));
